...
| [spec/pages.md](spec/pages.md) | Page file layout (Phase 2B) |
...
Operations guides (`docs/ops/`) and SDK docs (`docs/sdk/`) are added in later phases. The value spec landed in Phase 1. The page-file spec landed in Phase 2B.
